          ...
          <div className="w-full h-full bg-[#E8D1B5] rounded-[1.2rem] p-2.5 flex flex-col justify-between relative box-border">
            ...
            <div className="w-full h-[18%] flex gap-[3%] relative">
              <button 
                ...
                className={`w-[22%] h-full rounded-sm flex items-center justify-center transition-all relative ${activeZone === mapZones.green.id ? 'ring-4 ring-white z-10 scale-105' : 'hover:brightness-110'}`}
              ...
              <button 
                ...
                className={`w-[22%] h-full rounded-sm flex items-center justify-center transition-all relative ${activeZone === mapZones.purple.id ? 'ring-4 ring-white z-10 scale-105' : 'hover:brightness-110'}`}
            ...
            <div className="w-full h-[12%] bg-[#875e47] my-[1%] rounded-sm flex items-center px-3">
              <span className="text-[#E8D1B5]/40 font-serif text-xs tracking-wide select-none uppercase font-bold">
                Hallway
              </span>
            </div>
            ...
            <div className="w-full h-[53%] flex justify-between relative">
              ...
              <button 
                ...
                className={`w-[28%] h-full border-[3px] border-white rounded-sm flex items-center justify-center transition-all relative ${activeZone === mapZones.orange.id ? 'ring-4 ring-white z-10 scale-102' : 'hover:brightness-110'}`}
              ...
              <button 
                ...
                className={`w-[14%] h-full rounded-sm flex items-center justify-center transition-all relative ${activeZone === mapZones.darkGreen.id ? 'ring-4 ring-white z-10 scale-102' : 'hover:brightness-110'}`}
